...
#    print("\n")
    ...
    while i < len(goals):
        ...
        for action in possible_actions:
            ...
            print("\n\nadding solution to plan.")
            print(padding + "Current Plan: {0}".format(" -> ".join([x.simple_str() for x in solution])))
            print("New plan")
            plan.extend(solution)
            print(padding + "Current Plan: {0}".format(" -> ".join([x.simple_str() for x in plan])))
            print("\n\n")
